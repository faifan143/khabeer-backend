...
export class OrdersController {
  ...
  async createMultipleServices(
    @Body() createOrderDto: CreateOrderMultipleServicesDto,
    @Request() req,
  ) {
    return this.ordersService.createMultipleServices(
      createOrderDto,
      req.user.userId,
    );
  }
  ...
  @Delete(':id')
  @Roles('USER')
  async deleteOrder(@Param('id', ParseIntPipe) id: number, @Request() req) {
