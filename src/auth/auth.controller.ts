...
export class AuthController {
  ...
  async sendPhoneLoginOtp(@Body() phoneLoginDto: PhoneLoginDto) {
  ...
  @ApiOperation({ summary: 'Register with phone verification' })
  ...
  async registerWithPhone(@Body() body: any, @UploadedFile() file: Express.Multer.File) {
    ...
    if (!body.phoneNumber || !body.otp || !body.name || !body.password) {
      throw new BadRequestException('Phone number, OTP, name, and password are required');
    }
