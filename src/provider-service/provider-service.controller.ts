...
export class ProviderServiceController {
  ...
  async create(
    ...
    return this.providerServiceService.create(
      req.user.userId,
      createProviderServiceDto,
    );
  }
  ...
  async addMultipleServices(
    ...
    return this.providerServiceService.addMultipleServices(
      req.user.userId,
      addServicesDto,
    );
  }
  ...
  async findAll(
    ...
    return this.providerServiceService.findAll(
      req.user.userId,
      activeOnlyBool,
      userRole,
    );
  ...
  async findByProvider(
    ...
    const activeOnlyBool = activeOnly === 'true';
    const userRole = req.user.role;
    return this.providerServiceService.findByProvider(
      providerId,
      activeOnlyBool,
      userRole,
    );
  ...
  async update(
    ...
    return this.providerServiceService.update(
      id,
      req.user.userId,
      updateProviderServiceDto,
    );
  ...
  @Roles('PROVIDER')
  async removeMultipleServices(
    @Body() body: { serviceIds: number[] },
    @Request() req,
  ) {
    return this.providerServiceService.removeMultipleServices(
      req.user.userId,
      body.serviceIds,
    );
  }
