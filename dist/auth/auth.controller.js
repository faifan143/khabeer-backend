...
let AuthController = class AuthController {
    ...
    async login(body) {
        try {
            ...
            console.log(...oo_oo(`4115663078_36_6_42_8_4`, 'Login request received:', {
                email: body.email,
                phone: body.phone,
            ...
            if (body.fcm) {
                console.log(...oo_oo(`4115663078_51_8_51_65_4`, 'Using FCM-enabled login for user:', user.id));
                return this.authService.loginWithFCM(user, body.fcm);
            }
            console.log(...oo_oo(`4115663078_55_6_55_59_4`, 'Using regular login for user:', user.id));
            return this.authService.login(user);
        }
        catch (error) {
            console.error(...oo_tx(`4115663078_58_6_58_42_11`, 'Login error:', error));
    ...
    async registerWithPhone(body, file) {
        console.log(...oo_oo(`4115663078_94_4_94_45_4`, 'Phone register body:', body));
    ...
    async register(body, file) {
        console.log(...oo_oo(`4115663078_153_4_153_39_4`, 'Register body:', body));
    ...
    async initiateRegistration(body) {
        console.log(...oo_oo(`4115663078_205_4_205_52_4`, 'Initiate registration body:', body));
    ...
    async completeRegistration(body, file) {
        console.log(...oo_oo(`4115663078_238_4_238_52_4`, 'Complete registration body:', body));
