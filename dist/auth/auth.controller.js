...
let AuthController = class AuthController {
    ...
    async login(body) {
        try {
            console.log(...oo_oo(`2870715814_26_6_32_8_4`, 'Login request received:', {
                email: body.email,
                phone: body.phone,
            ...
            if (body.fcm) {
                console.log(...oo_oo(`2870715814_41_8_41_65_4`, 'Using FCM-enabled login for user:', user.id));
                return this.authService.loginWithFCM(user, body.fcm);
            }
            console.log(...oo_oo(`2870715814_45_6_45_59_4`, 'Using regular login for user:', user.id));
            return this.authService.login(user);
        }
        catch (error) {
            console.error(...oo_tx(`2870715814_48_6_48_42_11`, 'Login error:', error));
    ...
    async registerWithPhone(body, file) {
        console.log(...oo_oo(`2870715814_84_4_84_45_4`, 'Phone register body:', body));
    ...
    async register(body, file) {
        console.log(...oo_oo(`2870715814_143_4_143_39_4`, 'Register body:', body));
    ...
    async initiateRegistration(body) {
        console.log(...oo_oo(`2870715814_195_4_195_52_4`, 'Initiate registration body:', body));
    ...
    async completeRegistration(body, file) {
        console.log(...oo_oo(`2870715814_228_4_228_52_4`, 'Complete registration body:', body));
        if (!body.password || !body.name || !body.phoneNumber || !body.otp) {
            throw new common_1.BadRequestException('Password, name, phone number, and OTP are required');
        }
        const registerData = {
            name: Array.isArray(body.name) ? body.name[0] : body.name,
            email: Array.isArray(body.email) ? body.email[0] : body.email,
