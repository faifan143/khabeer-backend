...
let AuthService = class AuthService {
    ...
    async validateUser(loginData) {
        try {
            ...
            if (email && !phone) {
                console.log(...oo_oo(`451584380_38_8_38_76_4`, `[DEBUG] Attempting provider login for email: ${email}`));
                const provider = await this.providersService.findByEmail(email);
                console.log(...oo_oo(`451584380_40_8_46_24_4`, `[DEBUG] Provider found:`, provider ? {
                    id: provider.id,
                ...
                if (provider && provider.password) {
                    ...
                    console.log(...oo_oo(`451584380_50_10_50_79_4`, `[DEBUG] Password validation result: ${isPasswordValid}`));
                    if (isPasswordValid) {
                        if (!provider.isVerified) {
                            console.log(...oo_oo(`451584380_55_14_55_90_4`, `[DEBUG] Provider not verified, throwing UnauthorizedException`));
                        ...
                        console.log(...oo_oo(`451584380_59_12_59_139_4`, `[DEBUG] Provider authentication successful, returning:`, { id: result.id, email: result.email, role: 'PROVIDER' }));
                        return { ...result, role: 'PROVIDER' };
                    }
                    else {
                        console.log(...oo_oo(`451584380_62_12_62_74_4`, `[DEBUG] Password validation failed for provider`));
                    }
                }
                else {
                    console.log(...oo_oo(`451584380_65_10_65_70_4`, `[DEBUG] Provider not found or has no password`));
                }
            }
            if (phone && !email) {
            ...
            console.error(...oo_tx(`451584380_86_6_86_51_11`, 'Authentication error:', error));
    ...
    async register(data) {
        try {
            ...
            console.error(...oo_tx(`451584380_266_6_266_49_11`, 'Registration error:', error));
    ...
    async activateProviderAccount(providerId) {
        try {
            console.log(...oo_oo(`451584380_402_6_402_73_4`, 'Attempting to activate provider with ID:', providerId));
            ...
            console.error(...oo_tx(`451584380_420_6_420_64_11`, 'Error activating provider account:', error));
            throw new common_1.InternalServerErrorException('Error activating account');
        }
    }
    async deactivateProviderAccount(providerId) {
        try {
            console.log(...oo_oo(`451584380_427_6_427_75_4`, 'Attempting to deactivate provider with ID:', providerId));
            const provider = await this.providersService.findById(providerId);
            ...
            console.error(...oo_tx(`451584380_441_6_441_66_11`, 'Error deactivating provider account:', error));
    ...
    async completeRegistration(data) {
        try {
            const { phoneNumber, otp, ...registerData } = data;
            console.log(...oo_oo(`451584380_762_6_768_8_4`, `[DEBUG] Complete registration - Received data:`, {
                phoneNumber,
                otp,
            ...
            console.log(...oo_oo(`451584380_811_6_811_129_4`, `[DEBUG] Password hashing - Original: ${registerData.password}, Hashed: ${hashedPassword.substring(0, 20)}...`));
            const userData = {
            ...
            if (registerData.role === 'PROVIDER') {
                ...
                console.log(...oo_oo(`451584380_845_8_850_10_4`, `[DEBUG] Creating provider with data:`, {
