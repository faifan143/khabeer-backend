...
let AuthService = class AuthService {
    ...
    async validateUser(loginData) {
        try {
            ...
            console.error(...oo_tx(`627332557_66_6_66_51_11`, 'Authentication error:', error));
    ...
    async register(data) {
        try {
            ...
            console.error(...oo_tx(`627332557_246_6_246_49_11`, 'Registration error:', error));
    ...
    async activateProviderAccount(providerId) {
        try {
            console.log(...oo_oo(`627332557_382_6_382_73_4`, 'Attempting to activate provider with ID:', providerId));
            ...
            console.error(...oo_tx(`627332557_400_6_400_64_11`, 'Error activating provider account:', error));
            throw new common_1.InternalServerErrorException('Error activating account');
        }
    }
    async deactivateProviderAccount(providerId) {
        try {
            console.log(...oo_oo(`627332557_407_6_407_75_4`, 'Attempting to deactivate provider with ID:', providerId));
            const provider = await this.providersService.findById(providerId);
            ...
            console.error(...oo_tx(`627332557_421_6_421_66_11`, 'Error deactivating provider account:', error));
