...
let OrdersService = class OrdersService {
    ...
    async create(createOrderDto, userId) {
        ...
        try {
            ...
            console.error(...oo_tx(`4186313364_119_6_119_68_11`, 'Failed to send new order notification:', error));
        }
    ...
    async updateStatus(id, updateStatusDto, userId, role) {
        ...
        try {
            ...
            console.error(...oo_tx(`4186313364_302_6_302_71_11`, 'Failed to send order status notification:', error));
        }
        return updatedOrder;
    }
