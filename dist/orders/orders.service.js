...
let OrdersService = class OrdersService {
    ...
    async create(createOrderDto, userId) {
        ...
        try {
            ...
            console.error(...oo_tx(`4125126163_119_6_119_68_11`, 'Failed to send new order notification:', error));
        }
    ...
    async updateStatus(id, updateStatusDto, userId, role) {
        ...
        try {
            ...
            console.error(...oo_tx(`4125126163_308_6_308_71_11`, 'Failed to send order status notification:', error));
        }
        return updatedOrder;
    }
